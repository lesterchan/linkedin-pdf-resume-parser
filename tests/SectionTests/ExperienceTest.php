...
class ExperienceTest extends AbstractSectionTest
{
    ...
    protected function setUp()
    {
        ...
        $this->experiences = $this->parsePdf($this->getName())->getExperiences();
    }
    ...
    {
        $this->assertEmpty($this->experiences);
    }
}
